...
public:
    ...
    virtual ERROR_CODE_T WriteData(const CHAR8 *pFormatMsg, ...);
    virtual ERROR_CODE_T WriteData(const string &formatMsg, ...);
    virtual ERROR_CODE_T WriteDataIgnoreResponse(const CHAR8 *pFormatMsg, ...);
    ...
    virtual ERROR_CODE_T SetCfgValueIgnoreResponse(CHAR8 *pCfgOption, const string &formatStr, ...);
    virtual ERROR_CODE_T GetCfgValue(string &outString, const CHAR8 *pCfgOption);
    ...
    virtual ERROR_CODE_T SendPlayCommand(string btAddress);
