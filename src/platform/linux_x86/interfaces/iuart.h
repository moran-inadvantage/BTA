...
public:
    ...
    virtual ~IUart( void ) {};
    virtual ERROR_CODE_T Open( BAUDRATE Baud, BYTE_SIZE ByteSize, PARITY Parity, STOP_BITS StopBits ) = 0;
    ...
    virtual void WritePort( const INT8U *pBuf, INT32U BytesToWrite, INT32U *pBytesWritten ) = 0;
